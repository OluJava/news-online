...
<body>
    ...
    <div class="container">
        ...
        <nav id="main-navigation" class="clearfix">
            <ul>
                <li><a href="#">Business <i class="arrow-main-nav"></i></a>
                    <ul>
                        <li><a href="single_review.html">Stock</a></li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="headlines clearfix">
            ...
            <div class="text-rotator">
                <div><a href="#" title="View permalink Title">Title</a></div>
            </div>
        </div> <!-- End Headlines -->
            ...
            <div id="main" class="span8 image-preloader">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6 post no-margin-left">
                        ...
                        <div class="text">
                            ...
                            <ul class="list-arrow-bold" style="margin-left: 10px">
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Alvear Art Black and White Theme</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Baltic Park Molo</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Glass House Below The Moon Light</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">House in The Woods</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Living Room in Italy</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="span6 post">
                        <figure>
                            <img src="images/content/600/2.jpg" alt="Thumbnail 2" />
                            <div class="cat-name">
                                <span class="base"><a style="color: #FFF" href="#">Business</a></span>
                                <span class="arrow"></span>
                            </div>
                        </figure>
                        <div class="text">
                            <h2><a href="#">Glass House Below The Dark of Moon Light</a></h2>
                            <ul class="list-arrow-bold" style="margin-left: 10px">
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Camerette - Your Time to Explore</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Casa en la costa del uno</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Glass House Below The Moon Light</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">House in The Woods</a></li>
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="#">Living Room in Italy</a></li>
                            </ul>
