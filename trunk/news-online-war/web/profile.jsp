     ...
     <form action="Client" name="registerform">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input class="inputDate" id="inputDate" type="text" readonly value="<%=birthday%>" name="insertBirthday"/></td>
                            </tr>
                            <tr>
                                <td><label>Gender <span class="font-required">*</span></label></td>
                                <td><input type="radio" name="insertrd1" value="Male"<%if(gender){%>checked<%}%>/> Male <input type="radio" value="Female" name="insertrd1" <%if(!gender){%>checked<%}%> /> Female</td>
                            </tr>

                            <tr>
                                <td><label>Address <span class="font-required">*</span></label></td>
                                <td><input type="text" name="insertAddress" maxlength="100" id="address" value="<%=address%>"/></td>
                            </tr>
                            <tr>
                                <td><label>Phone number <span class="font-required">*</span></label></td>
                                <td><input type="text" name="insertPhoneNumber" maxlength="11" id="phone" value="<%=phone%>" /></td>
                            </tr>
                            <tr>
