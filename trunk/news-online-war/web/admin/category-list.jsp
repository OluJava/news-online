<%-- 
    ...
    Created on : Apr 26, 2013, 9:58:35 AM
    Author     : Khatmau_sr
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Categories | NewsOnline Admin</title>
		...
		<div class="box round first grid">
			...
			<table class="data display datatable" id="example">
				...
				<tr class="odd gradeX">
				    ...
				    <td align="center">
					<a href="/news-online-war/Admin?action=category-edit&cateId=${item.categoryId}">
					    <img src="admin/img/edit.png" alt="Edit Category"/>
					</a>
				    </td>
				    <td align="center">
					<a onclick="return confirm('Are you sure you want to remove this category?')" href="/news-online-war/Admin?action=removeCategory&cateId=${item.categoryId}">
					    <img src="admin/img/trash.png" alt="Remove Categorys"/>
					</a>
				    </td>
				</tr>
				</c:forEach>
