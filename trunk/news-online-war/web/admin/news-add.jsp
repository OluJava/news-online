		...
		<div class="box sidemenu">
            ...
            <div class="grid_10">
				...
				<tr>
				    ...
				    <td>
					<div id="basic-modal">
					<input type="text" id="image" name="image" readonly="true" class="mini" value="no-photo.jpg"/>
				...
				<tr>
				    ...
				    <td>
					<img id="imgPreview" src="admin/img/no-photo.jpg" alt="" width="240px" height="180px"/>
				    </td>
				</tr>
				<tr>
				...
				<tr>
				    ...
				    <td>
					<input type="text" name="tags" class="mini" maxlength="50" value=""/> Optional! Use (;) to separate multiple tags.
				    </td>
				</tr>
				<tr>
				    <td></td>
