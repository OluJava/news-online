    ...
    <div id="top-navigation">
        <div class="container">
            ...
            <ul class="nav-menu pull-left">
                <li class="active"><a href="Controller?action=goHome">Home</a></li>
                <li><a href="about-us.jsp">About Us</a></li>
                <li><a href="feedback.jsp">Feedback</a></li>
            </ul>

            <!-- Search Form -->
            <form name="form-search" method="post" action="Controller?action=search" class="form-search pull-right">
    ...
    <div class="container">
        <header id="header" class="clearfix">
            ...
            <div class="logo pull-left">
                <a href="Controller?action=goHome"><img src="images/logo.png" alt="Enews" /></a>
            </div>
		...
		<c:forEach items="${cateList}" var="item">
		    <li><a href="Controller?action=viewCategory&cateId=${item.categoryId}">${item.title}</a></li>
		</c:forEach>
            </ul>
        ...
        <div id="highlight-posts" class="clearfix">
            <ul>
                <li class="masked masked-big">
                    ...
                    <a href="Controller?action=viewDetail&newsId=${headMain.newsId}" title="Title"><div class="masked-hover"></div></a> <!-- Masked Hover -->
                ...
                <li class="masked masked-small"> <!-- Two -->
                    ...
                    <a href="Controller?action=viewDetail&newsId=${headFirst.newsId}" title="Title"><div class="masked-hover"></div></a> <!-- Masked Hover -->
                    <div class="masked-base"></div> <!-- Masked Base -->
                ...
                <li class="masked masked-small"> <!-- Three -->
                    ...
                    <a href="Controller?action=viewDetail&newsId=${headSecond.newsId}" title="Title"><div class="masked-hover"></div></a> <!-- Masked Hover -->
                    <div class="masked-base"></div> <!-- Masked Base -->
                ...
                <li class="masked masked-small no-margin-bottom"> <!-- Four -->
                    ...
                    <a href="Controller?action=viewDetail&newsId=${headThirth.newsId}" title="#"><div class="masked-hover"></div></a> <!-- Masked Hover -->
                    <div class="masked-base"></div> <!-- Masked Base -->
		...
		<c:forEach items="${lineList}" var="item">
		    <div><a  href="Controller?action=viewDetail&newsId=${item.newsId}">${item.title}</a></div>
		</c:forEach>
            </div>
        </div> <!-- End Headlines -->
			...
			<c:choose>
				...
				<div class="span6 post">
                        ...
                        <figure>
                            ...
                            <div class="cat-name">
                                <span class="base">
				    <a style="color: #FFF" href="Controller?action=viewCategory&cateId=${list[0].category.categoryId}">${list[0].category.title}</a>
				</span>
                                <span class="arrow"></span>
                            </div>
                        </figure>
                        <div class="text" style="height: 175px">
                            <h2><a href="Controller?action=viewDetail&newsId=${list[0].newsId}">${list[0].title}</a></h2>
                            <ul class="list-arrow-bold" style="margin-left: 10px">
				<c:forEach items="${list}" var="item" varStatus="loop">
				    <c:if test="${loop.index > 0 && loop.index < 5}">
                                <li style="font-size: 13px; line-height:1.5em; font-weight: bold"><a href="Controller?action=viewDetail&newsId=${item.newsId}">${item.title}</a></li>
				    </c:if>
				</c:forEach>
                            </ul>
                        </div>
		...
		<div class="enews-tab">
			...
			<div class="tab-pane active" id="tab-populars">
				...
				<div class="pull-right content">
				    <h4><a href="Controller?action=viewDetail&newsId=${item.newsId}" title="">${item.title}</a></h4>
